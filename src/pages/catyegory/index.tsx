...
import Category5 from './../../assets/images/p5.svg'
import Category6 from './../../assets/images/p6.svg'
                    ...
                    <div className="recent-work-section">
                         ...
                         <div className="recent-task-list">
                              <div className="recent-media">
                                   <img src={RecentOne} alt="recent picture" />
                              </div>
                         ...
                         <div className="recent-task-list">
                              <div className="recent-media">
                                   <img src={RecentTwo} alt="recent pictur" />
                              </div>
                              <div className="recent-content-part">
                                   <h3>Docu sign</h3>
